...
object DashItems {
    ...
    private val studentItems: List<String> = arrayListOf("assignments_submit", "events", "forum")
    ...
    private val adminItems: List<String> = arrayListOf("admin_portal", "events", "forum")
}